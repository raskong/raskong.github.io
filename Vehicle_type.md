...
To get a better picture of if there is a veihcle type that is more destrucktive in in a crash, we have below plotted a count matrix of number of people injured vs veh normalized    
